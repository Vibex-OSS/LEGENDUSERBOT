...
if ALIVE_PIC is None :
    ALIVE_PIC = "https://telegra.ph/file/feadbe63818bc695c0417.jpg"

DEFAULTUSER = str ( ALIVE_NAME ) if ALIVE_NAME else "Set ALIVE_NAME in config vars in Heroku"

ALIVE_MESSAGE = Config.ALIVE_MSG
ALIVE_MESSAGE = "**🔱Legend Zinda Tha....Zinda Hai....Aur Zinda Rahega🔱 \n\n\n**"
...
ALIVE_MESSAGE += f"`Support Channel` : @Legend_Mr_Hacker \n\n"
